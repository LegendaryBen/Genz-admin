...
const Edit_story = (props) => {
    ...
    const removeStory = ()=>{
            ...
            if(token  == ''){
                ...
                axios.delete(`https://gen-zsquare.com/api/story/update/${ids}`,{
                    headers: {
    ...
    const uploadStory = ()=>{
        ...
        if(title == "" || intro == "" || body == "" || category == "" || image == null || source == "" || storyby == ""){
            ...
            if(token  == ''){
                ...
                axios.patch(`https://gen-zsquare.com/api/story/update/${ids}`,formData,{
                    headers: {
                      'Authorization': `Bearer ${token}`,
